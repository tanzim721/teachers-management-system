<nav class="navbar navbar-expand-lg navbar-info okOk text-center">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav col-lg-11">
            ...
            <li class="dropdown">
                <a href="#" class="pt-5 dropbtn">PHOTO</a>
            </li>
            <li class="dropdown">
                <a href="#" class="pt-5 dropbtn">SERVICES</a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="#" class="text-bold">Notice</a>
                    <a href="" class="text-bold">Overview</a>
                    <a href="" class="text-bold" >Overview</a>
                </div>
            </li>
            <li class="dropdown">
                <a href="#" class="pt-5 dropbtn">CONTACT TEACHERS</a>
            </li>
        </ul> 
